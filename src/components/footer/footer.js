  ...
  return (
    <div className="w-full py-5 bg-[#000]  curved-top text-[#fff] flex flex-col gap-5">
      <div className="flex flex-col items-center pt-10 max-sm:pt-5">
        <img
          src={logo}
          alt="Fucturica Tech Logo"
          className="max-xl:w-[300px] max-md:w-[250px] max-sm:w-[200px]"
        />
        <div className="grid grid-cols-4 max-lg:grid-cols-2 max-lg:gap-y-10 w-[90%] py-10">
          <div className="flex flex-col gap-5 max-sm:col-span-2">
            ...
            <div className="relative">
              <input
                ...
                className="bg-[#666666] rounded-[30px] w-full p-4"
              />
              <img
                src={img}
                alt="message"
                className="absolute top-0 right-2 mt-1"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col items-start">
            <h3 className="text-2xl max-xl:text-lg font-semibold mb-[32px]">
              Office
            </h3>
