...
const SelfDeclaration = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.username || !formData.mobile || !formData.email || !formData.address || !formData.termsAccepted) {
    ...
    return (
        <div className='w-full flex justify-center py-10'>
            <div className='w-[90%] flex flex-col gap-10'>
                <div>
                    <h2 className='text-[#666666] text-center text-[52px] max-xl:text-[35px] max-lg:text-[28px] max-sm:text-[24px] font-semibold'>Welcome to <span className='text-[#FB861E]'>Fucturica Technologies </span></h2>
                </div>
