                ...
                <div className='w-[90%] flex max-sm:flex-col items-center gap-20 max-sm:gap-0 justify-between'>
                    <div className='flex flex-col justify-center gap-5 max-sm:gap-2 max-md:w-full'>
                        ...
                        <div className='flex gap-10 max-lg:gap-5'>
                            <Link to='/contact-us'><button className='hover:bg-[#007BFF] max-sm:border-[1px] border-2 border-[#007BFF] py-2 px-4 max-lg:py-1 max-lg:px-3 text-[#007BFF] hover:text-[#fff] flex items-center gap-3 text-[20px] max-lg:text-[16px] max-md:text-[12px] rounded-[30px]'>Get in touch<GoArrowRight className='text-[30px] max-lg:text-[20px]' /></button></Link>
                            <Link to='/services'><button className='border-2 max-sm:border-[1px] border-[#007BFF] text-[#007BFF] hover:bg-[#007BFF] hover:text-[#fff] text-[20px] max-lg:text-[16px] max-md:text-[12px] rounded-[30px] px-4 py-2 max-lg:py-1 max-lg:px-3 flex gap-3 items-center'>Learn More<IoAddOutline className='text-[30px] max-lg:text-[20px]' /></button></Link>
                        </div>
                    </div>
