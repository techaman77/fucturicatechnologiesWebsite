                ...
                <tbody>
                    {formsFetched.map((user, index) => (
                        <tr key={index}>
                            ...
                            <td className="px-4 py-2 border">{(user.experience || []).filter(exp => exp).join(', ') || 'N/A'}</td>
                            <td className="px-4 py-2 border">{user.roleResponsibilities || 'N/A'}</td>
                            <td className="px-4 py-2 border">{(user.softSkills || []).join(', ') || 'N/A'}</td>
                            <td className="px-4 py-2 border">{(user.technicalSkills || []).join(', ') || 'N/A'}</td>
                            <td className="px-4 py-2 border">{user.fatherName || 'N/A'}</td>
                            <td className="px-4 py-2 border">{user.motherName || 'N/A'}</td>
                            <td className="px-4 py-2 border">{user.dateOfBirth || 'N/A'}</td>
                            <td className="px-4 py-2 border">{user.maritalStatus || 'N/A'}</td>
                            <td className="px-4 py-2 border">{user.permanentAddress || 'N/A'}</td>
                            <td className="px-4 py-2 border">{user.profile || 'N/A'}</td>
                            <td className="px-4 py-2 border">{user.linkedIn || 'N/A'}</td>
                            <td className="px-4 py-2 border">{(user.languages || []).join(', ') || 'N/A'}</td>
                            <td className="px-4 py-2 border">{user.mistakesCount || 'N/A'}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
