            ...
            <div className="flex justify-between items-center w-[90%] max-md:flex-col">
                <div className="flex flex-col justify-center gap-5 max-md:w-full">
                    ...
                    <div className='flex gap-10 max-lg:gap-5'>
                        <p className='bg-[#007BFF] py-2 px-4 max-lg:py-1 max-lg:px-3 text-[#fff] flex items-center gap-3 text-[20px] max-lg:text-[16px] max-md:text-[12px] rounded-[30px]'>Get in touch<GoArrowRight className='text-[30px] max-lg:text-[20px]' /></p>
                        <p className='border-2 max-sm:border-[1px] border-[#007BFF] text-[20px] max-lg:text-[16px] max-md:text-[12px] rounded-[30px] px-4 py-2 max-lg:py-1 max-lg:px-3 flex gap-3 items-center'>Learn More<IoAddOutline className='text-[#007BFF] text-[30px] max-lg:text-[20px]'/></p>
                    </div>
                </div>
