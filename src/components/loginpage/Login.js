...
const Login = () => {
  ...
  return (
    <>
      <div className="w-full flex flex-col md:flex-row sm:flex-row min-h-screen font-montserrat mb-20 sm:mb-10">
        <div className="w-full md:w-1/2 h-screen bgimage bg-cover bg-center relative bg-no-repeat mb-10">
        ...
        <div className="flex w-full md:w-1/2 flex-col justify-center items-center p-4 md:p-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5 w-full max-w-md mx-auto items-center">
            ...
            <button type="submit" className="mt-4 bg-gradient-to-r from-blue-500 to-blue-700 text-white p-2 rounded-full w-[30%] max-w-xs" disabled={isSubmitting}>
